...
public class clientTable extends javax.swing.JFrame {
  ...
  public void setClients(MongoCursor clientes) {
    this.tablaClientes.removeAll();
    DefaultTableModel model = (DefaultTableModel) this.tablaClientes.getModel();
    Document auxDoc;
    while(clientes.hasNext()) {
      auxDoc = (Document) clientes.next();
      model.addRow(new Object[]{auxDoc.get("codigocliente"), auxDoc.get("totalcomprado")});
    }
